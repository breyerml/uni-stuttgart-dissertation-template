...
\usepackage{tikz}
\usetikzlibrary{shapes, arrows.meta, positioning, decorations.pathreplacing, trees, patterns, calligraphy, mindmap, shapes.geometric, positioning, decorations, decorations.text,}
% \usepackage{tikz}
...
\includeonly{content/03_hardware_and_software, content/04_performance_sampling_hws}
...
\include{content/03_hardware_and_software}
\include{content/04_performance_sampling_hws}
