...
% Define a custom box for disadvantages
\newtcolorbox{disadvantagebox2}[1]{
    colback=red!10!white,
    colframe=red!50!black,
    title=\textbf{Disadvantages},
    fonttitle=\bfseries,
...
\begin{minipage}[t]{0.49\textwidth}
    \vspace{0pt}
    \begin{disadvantagebox2}{#1}
        \begin{itemize}[leftmargin=2.5mm]
            \setlength\itemsep{0.0em}
            #3
        \end{itemize}
    \end{disadvantagebox2}
\end{minipage}\newline
}
...
\includeonly{content/02_performance_portability, content/03_hardware}
