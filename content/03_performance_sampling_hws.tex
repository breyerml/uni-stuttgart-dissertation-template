...
Also, in the age of \glspl{llm} with the ever-increasing number of parameters and supercomputers that get bigger and bigger~\cite{top500org_november_2024}, energy consumption gets more and more important~\cite{de_vries_growing_2023, luccioni_estimating_2023}. 
Yet, gathering the energy consumption in a vendor-independent way for different hardware platforms is not as straightforward as initially seems. 
