...
Collecting walltimes is straightforward and can directly be done in the used programming language using some clock. 
However, gathering the achieved \glspl{flops} or memory bandwidth is more difficult. 
The theoretical peak performance must also be known to calculate the reached efficiency. 
...
\newpage
\input{content/02_performance_portability/01_performance/03_performance_sampling}