...
A \textit{platform} $\mathbf{i}$ is a particular execution environment, mostly interpreted as a specific hardware; the set of all possible platforms is denoted as $\mathbf{H}$. 
